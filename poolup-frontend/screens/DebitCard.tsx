...
function TransactionItem({ transaction }) {
  ...
  return (
    <View style={{ backgroundColor: 'white', padding: 16, borderRadius: radius.medium, marginBottom: 8 }}>
...
export default function DebitCard({ navigation, route }: any) {
  ...
  const initialCard = (route.params as any)?.card;
  ...
  const loadData = async () => {
    try {
      ...
      setCard(null);
      setTransactions([]);
      setInsights({ categoryBreakdown: [] });
      setPerks({ travel_credits: 5000, lounge_access: true });
      setBankAccounts([]);
      
      console.log('DebitCard loaded with real data');
    } catch (error) {
    ...
    <ScrollView style={{ flex: 1, backgroundColor: '#FAFCFF' }}>
      ...
      <View style={{ padding: 24, paddingTop: 16 }}>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 16 }}>
          <View style={{ backgroundColor: 'white', padding: 16, borderRadius: radius.medium, flex: 1, marginRight: 8 }}>
          ...
          <View style={{ backgroundColor: 'white', padding: 16, borderRadius: radius.medium, flex: 1, marginLeft: 8 }}>
        ...
        <View style={{ backgroundColor: 'white', padding: 16, borderRadius: radius.medium, marginBottom: 16 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 12 }}>
            ...
            <TouchableOpacity 
              ...
              style={{ backgroundColor: colors.blue, padding: 12, borderRadius: radius.medium, flex: 1 }}
            >
              <Text style={{ color: 'white', fontWeight: '700', textAlign: 'center' }}>
                💳 Test Purchase
              </Text>
